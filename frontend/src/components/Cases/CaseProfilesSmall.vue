...
import CaseProfileCardSmall from './CaseProfileCardSmall.vue'
...
// Filter across all relevant properties of a case (mirror Large view)
...
<template>
  <div class="panel">
    <!-- Toolbar with search (mirrors CaseProfilesLarge) -->
...
.toolbar :deep(.p-inputtext), :deep(.p-inputtext) { width: 18rem; }
</style>
